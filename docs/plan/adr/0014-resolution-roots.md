...
| 2026-06-23 | Proposed → Accepted (Sign-off Auftraggeber: Weg A als JVM-Auflösungs-*Richtung*; tree-sitter/Modul-Graph verworfen). Ab jetzt immutable; die Umsetzung (Schema-`resolution`-Block) bleibt **gated** ([slice-015](../planning/done/wellenlos/slice-015-resolution-roots.md)) — die Spec-Schärfung folgt dort. Ablösung nur via Folge-ADR mit `Supersedes`. |
