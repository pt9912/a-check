...
| Datum | Ereignis |
|---|---|
| 2026-07-03 | Proposed — Entwurf mit slice-023; Evidenz d-check-Plan-Review + m-trace-Sichtung. |
| 2026-07-03 | Proposed → Accepted (Sign-off Auftraggeber: Entscheide a–d gemäß Empfehlung inkl. fail-closed für leeren/fehlenden `tech.adapter`, slice-023 §3). Ab jetzt immutable; Ablösung nur via Folge-ADR mit `Supersedes`. |
