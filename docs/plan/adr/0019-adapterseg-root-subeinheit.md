...
| Datum | Ereignis |
|---|---|
| 2026-07-03 | Proposed — Entwurf mit [slice-024](../planning/done/wellenlos/slice-024-adapterseg-root-subeinheit.md); Evidenz b-cad-Pilot (V3b: 39, V4 nach den dortigen Umbauten: 40 Falsch-Positive). |
| 2026-07-03 | Sign-off Auftraggeber für die Entscheide A–C (gemäß Empfehlung, [slice-024](../planning/done/wellenlos/slice-024-adapterseg-root-subeinheit.md) §6). |
...
| 2026-07-03 | Proposed → Accepted (Sign-off Auftraggeber: Entscheid D mit dem Merge-Wort bestätigt, [slice-024](../planning/done/wellenlos/slice-024-adapterseg-root-subeinheit.md) §6). Ab jetzt immutable; Ablösung nur via Folge-ADR mit `Supersedes`. |
