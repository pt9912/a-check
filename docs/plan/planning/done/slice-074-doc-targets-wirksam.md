...
- **Die Ablösung von `gate-consistency` (1)+(2).** Dass beide Prüfer dasselbe melden, ist in
  [slice-073](../done/slice-073-dcheck-statt-eigenbau.md) gemessen; die Entscheidung, den Eigenbau
...
- **Der CR an d-check**, dass ein aktiviertes, aber unkonfiguriertes Modul still `0 Befund(e)`
  ...
  [slice-073](../done/slice-073-dcheck-statt-eigenbau.md), nicht in eine lokale Korrektur.
...
**Folge-Slices:** [slice-073](../done/slice-073-dcheck-statt-eigenbau.md) entscheidet, ob
