...
(`adr/README.template.md` (`v6.2.0` · `templates/docs/plan/adr/README.template.md`))
...
Die Ziel-Form
(`carveouts/README.template.md` (`v6.2.0` · `templates/docs/plan/carveouts/README.template.md`))
