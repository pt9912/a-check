...
- [`BEO-PLAN/verweis-auf-wandernden-slice`](../observations/BEO-PLAN/verweis-auf-wandernden-slice/observation.md)
  ...
  [slice-180](../in-progress/slice-180-slice-mv-dritte-verweis-form.md). `make slice-mv`
...
- [slice-180](../in-progress/slice-180-slice-mv-dritte-verweis-form.md) — `slice-mv` lernt
