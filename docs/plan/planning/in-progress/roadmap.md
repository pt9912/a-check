...
**Parallel offen — `welle-05-release`:** `v0.1.0` … `v0.4.0` und **`v0.5.0`** sind veröffentlicht
...
`@sha256:81951e61…` (aktuell v0.5.0) digest-gepinnt in `a-check.mk`); nur die
