...
| welle-01-fundament | 2026-06-21 | [slice-001](../done/welle-01/slice-001-fundament-adrs.md) §7 — Fundament-ADRs [ADR-0001](../../adr/0001-go-impl-sprache.md)…[ADR-0004](../../adr/0004-distribution-image-mk.md) `Accepted` |
| welle-02-spec | 2026-06-21 | [slice-002](../done/welle-02/slice-002-architektur-spezifikation.md) §7 — Technik-/Sicht-Stratum (`SPEC-*`/`ARC-*`) |
| welle-03-implementierung | 2026-06-21 | [slice-003](../done/welle-03/slice-003-implementierung-gates.md) §7 — Go-Implementierung + Gates; [ADR-0005](../../adr/0005-lint-profil.md)/[ADR-0006](../../adr/0006-coverage-gate.md) `Accepted` |
| welle-04-durchsetzungsschicht | 2026-06-21 | [slice-004](../done/welle-04/slice-004-durchsetzungsschicht.md) §4 — Meta-Gates `gate-consistency`/`record-gates` + `.claude`-Stop-Hook |
| welle-07-command-guard | 2026-06-21 | [slice-005](../done/welle-07/slice-005-command-guard.md) §4 — PreToolUse-Command-Guard (Tool-Call-Gate); Durchsetzungsschicht vollständig |
| welle-08-ci | 2026-06-21 | [slice-006](../done/welle-08/slice-006-ci-pipeline.md) §4 — PR-/Push-CI (`ci.yml`): `make ci` (+ `image-test`) + `make trace-check`; Dockerfile-OCI-Labels |
| welle-09-commit-hook | 2026-06-21 | [slice-008](../done/welle-09/slice-008-commit-msg-hook.md) §4 — lokaler `commit-msg`-Hook (`.githooks` + `make hooks`) |
| welle-10-regel-engine-generalisierung | 2026-06-23 | [slice-012](../done/welle-10/slice-012-driving-driven-layerof.md) §7 — Rollen-Dispatch + 4-Schichten-Modell + `driving`/`driven`-Richtung + `LayerOf` längster-literaler-Präfix; [ADR-0009](../../adr/0009-rollen-basierter-regel-dispatch.md)…[ADR-0013](../../adr/0013-layerof-laengster-praefix.md) `Accepted`. Carry-forward: [slice-013](../open/slice-013-driving-driven-vertiefung.md) |
| welle-06-sprach-backends | 2026-07-03 | [slice-022](../done/welle-06/slice-022-typescript-backend.md) §8 — vier Backends geliefert: Java ([slice-014](../done/welle-06/slice-014-java-backend.md)), Python ([slice-020](../done/welle-06/slice-020-python-backend.md)), C# ([slice-021](../done/welle-06/slice-021-csharp-backend.md)), TypeScript ([slice-022](../done/welle-06/slice-022-typescript-backend.md)); Auflösung `fixed-root` ([ADR-0016](../../adr/0016-resolution-sprach-parametrisch.md)) + `relative` ([ADR-0017](../../adr/0017-relative-resolution-modus.md)); `namespace` bleibt reserviert (Folge-Slice bei realem Pilot) |
| welle-11-dcheck-pilot-deltas | 2026-07-03 | [slice-023](../done/wellenlos/slice-023-dcheck-pilot-deltas.md) §4 — `tech.adapter`-Liste + `composition_root: allow\|forbid` + `exclude` ([ADR-0018](../../adr/0018-exclude-scan-scope.md) `Accepted`, Lastenheft/Spez 0.14.0), veröffentlicht in `v0.8.0` — d-check-Umstellung entsperrt |
| welle-12-regelwerk-migration | 2026-08-09 | [`done/welle-12-results.md`](../done/welle-12-results.md) — **erster realer Durchlauf der Fünf-Schritt-Prozedur**. Migration `v1.3.0` → `v3.5.2` in sechs Etappen ([slice-046](../done/welle-12/slice-046-regelwerk-v352-migration-analyse.md)…[slice-067](../done/welle-12/slice-067-roadmap-form.md)) plus der Nachlauf des ersten unabhängigen Reviews ([slice-068](../done/welle-12/slice-068-phony-vollstaendig.md)…[slice-078](../done/welle-12/slice-078-rollen-uebergaben.md)). Verifikation: `make ci` Exit 0, alle 33 Slices in `done/`, jedes belegte False-Green mit Gegenprobe. Carveout-Bestand null |
| welle-13-konsumenten-befunde | 2026-08-09 | [`done/welle-13-results.md`](../done/welle-13-results.md) — **erster Durchlauf mit Welle-Plan-Datei** (sie wanderte per `git mv` nach `done/`, womit Schritt 3 erstmals vollständig belegt ist). Sechs Change Requests aus einem realen Fremdrepo-Einsatz, sechs Slices ([slice-081](../done/welle-13/slice-081-heuristik-diagnose.md)…[slice-086](../done/welle-13/slice-086-forbidden-constructs-fail-closed.md)), vier ADRs ([ADR-0030](../../adr/0030-kein-digest-im-generierten-fragment.md)…[ADR-0033](../../adr/0033-forbidden-constructs-fail-closed.md)). Ergebnis: drei Laufzeit-Diagnosen auf einer Achse — Datei ohne Schicht, Zeile ohne Kante, Ziel ohne Schicht. Verifikation: `make ci` Exit 0, Carveout-Bestand null, alle sieben lokalen Konsumenten-Konfigurationen laden unverändert |
| welle-15-regelwerk-v650-migration | 2026-09-07 | [`done/welle-15-results.md`](../done/welle-15-results.md) — Regelwerk-Migration `v6.2.0`→`v6.5.0`, drei Releases übersprungen. Sechs Slices ([slice-174](../done/welle-15/slice-174-regelwerk-v650-delta-analyse.md)…[slice-179](../done/welle-15/slice-179-etappe-b-adaptions-durchgang-v650.md)), fünf Etappen. **Keine neue Adaption** — alle sieben aktiven bleiben. Verifikation: `make ci` Exit 0, Carveout-Bestand null, ein vendorter Stand. Zwei Register-Einträge erreichten die Schwelle: `review-geltungsbereich-zu-eng` **verkörpert** in [`AGENTS.md`](../../../../AGENTS.md) §5, `verweis-auf-wandernden-slice` mit benannter Lücke → [slice-180](../done/wellenlos/slice-180-slice-mv-dritte-verweis-form.md) |
...
|---|---|---|---|
| 2026-07-05 | [ADR-0020](../../adr/0020-mehr-wurzel-phantom-guard.md) → `Superseded` durch [ADR-0022](../../adr/0022-datei-mengen-bewusste-mehr-wurzel-aufloesung.md) | der Phantom-Guard unterdrückte das Symptom, ohne die Ursache zu treffen — die Auflösung war wurzel-, nicht datei-mengen-bewusst | [slice-026 §8](../done/wellenlos/slice-026-kmp-mehr-root-phantom.md), [slice-027 §9](../done/wellenlos/slice-027-kmp-multimodul-resolution.md) |
...
| 2026-07-25 | `strict_coverage` aus [slice-043](../done/wellenlos/slice-043-schicht-abdeckung-sichtbar.md) **vertagt** | die advisory Diagnose reicht für den belegten Bedarf; die harte Variante braucht erst einen Trigger | [ADR-0029](../../adr/0029-abdeckungs-diagnose-advisory.md) |
...
| 2026-07-25 | Regelwerk-Migration: Etappen wachsen von **vier** auf **sechs** (A · B · C · D · **E** · **F**), Reihenfolge **E vor D** | die vollständige Baseline-Lektüre brachte elf zusätzliche Funde; die Mechanik-Funde schaffen die Sensoren, an denen die Form-Funde hängen | [slice-048 §5](../done/welle-12/slice-048-modul-delta-lesen.md) |
| 2026-07-25 | `nolintlint` als geplante Umsetzung von B-11 **verworfen**, Ersatz `make suppression-check` | Negativ-Probe: der Linter prüft Wohlgeformtheit, nicht Existenz — ein wohlgeformtes `//nolint` ließ `make lint` grün | [slice-049 §1.1](../done/welle-12/slice-049-mechanik-sensoren.md) |
