...
> **Wiedereinstieg (Stand 2026-07-25).** [slice-042](../done/slice-042-constructs-aufruf-monopol.md) ist
> **abgenommen und umgesetzt** (in-progress, auf einem Slice-Branch): `constructs`-Roh-Text-Monopol
> mit der Regel `construct-leak` — Lastenheft **0.22.0**
...
> alle vier lokalen Konsumenten unverändert 0 Befunde
> ([slice-042 §10](../done/slice-042-constructs-aufruf-monopol.md)).
> **Nächster Schritt:** Review + Merge nach `main` (Merge/Push nur auf Wort), danach ein Release,
> das die Regel ausliefert — erst dann kann b-cad seine P1-`grep`-Regel zurückbauen
> ([slice-042 §10.4](../done/slice-042-constructs-aufruf-monopol.md)).
> **Danach offen:** [slice-043](../open/slice-043-schicht-abdeckung-sichtbar.md)
> (Schicht-Abdeckung sichtbar machen, Kandidat 2a entgated — Entscheide §3 stehen noch aus),
> [slice-013](../open/slice-013-driving-driven-vertiefung.md) und
> [slice-037](../open/slice-037-hexslice-gap-analyse.md); Kandidat 2b (Präfix-Allowlist) bleibt gated.
