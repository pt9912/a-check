...
(datei-mengen-bewusste Auflösung) als [slice-027](slice-027-kmp-multimodul-resolution.md)
(**in Umsetzung**, 2026-07-05: der Guard löst die legitime disjunkte Multi-Modul-Config nicht auf →
datei-mengen-bewusst korrigiert (Lastenheft/Spez **0.17.0**), Folge-ADR supersedet den Guard-ADR;
drei Abnahme-Entscheide gesetzt + Multi-Linsen-Review eingearbeitet, AC1–AC6 als Tests grün). [slice-028](../done/slice-028-dcheck-matrix-konvergenz.md) (**done** — d-check-Matrix-Konvergenz:
