...
| [slice-119](../open/slice-119-cr-text-guide.md) | eingetreten — [`BEO-022`](../observations.md) bei 3×, Schwelle überschritten | **startbar** — ein Guide, kein Werkzeug: für CR-Texte ist noch keiner gescheitert |
