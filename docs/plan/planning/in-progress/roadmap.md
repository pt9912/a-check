...
|---|---|---|
| [slice-128](../open/slice-128-dependabot-hebungskanal.md) | eingetreten — [slice-124](../done/slice-124-image-scan-cve.md) hat den Sensor geliefert, sein Erstlauf neun Befunde gemessen | **startbar** — der Kanal hebt, was der Sensor meldet; die `trace-check`-Kopplung ist vor der Konfiguration zu messen |
