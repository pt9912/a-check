...
| BEO-011 | Form-Vergleiche ungeprüft: `README.md` und die drei Spec-Straten — Namensvarianten oder echte Lücken, entscheidbar nur durch Lesen | Planungs-Harness | 2× | slice-105, slice-108 | offen — die `AGENTS.md`-Hälfte ist mit slice-108 gelesen und war eine **echte** Lücke (Hard Rule 3.7) |
