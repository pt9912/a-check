...
- **Ein Nachzug der Lab-Config des Konsumenten** — *ein anderer Vorgang in einem anderen Repo:*
  ...
  Gegenstand von [slice-194](../open/slice-194-portscope-richtungssegment.md), nicht dieses Slice.
...
[slice-194](../open/slice-194-portscope-richtungssegment.md) — dieser Slice zitiert dort nichts und
