...
`.harness/baseline/v6.0.0/templates/harness/README.template.md` §Sensors —
...
| `make gates` | aggregiert die inneren Gates (lint/test/coverage-gate/arch-check/doc-check/doc-targets/doc-planning/doc-workflows/gate-consistency/version-coherence/suppression-check/guard-selftest) + `record-gates` als letzter Schritt | — (Aggregat) |
