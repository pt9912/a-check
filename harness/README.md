...
| `make gates` | aggregiert die inneren Gates (lint/test/coverage-gate/arch-check/doc-check/doc-targets/doc-planning/doc-workflows/gate-consistency/version-coherence/suppression-check/dcheck-phrase-selftest/guard-selftest) + `record-gates` als letzter Schritt | — (Aggregat) |
