...
| `make gates` | aggregiert die inneren Gates (lint/test/coverage-gate/arch-check/doc-check/doc-targets/doc-planning/gate-consistency/suppression-check/guard-selftest) + `record-gates` als letzter Schritt | — (Aggregat) |
