...
| `make symlink-check` | jeder **getrackte** Symlink löst auf; `doc-check` sieht sie nicht, weil es bei einem Symlink den Zielinhalt liest statt den Linkpfad. Selbsttest in beide Richtungen über dieselbe Prüf-Funktion, die das Gate fährt | Harness-Prozess; Antwort auf [`BEO-GATE/symlink-ziel-nach-baseline-bump-ungeprueft`](../docs/plan/planning/observations/BEO-GATE/symlink-ziel-nach-baseline-bump-ungeprueft/observation.md) bei 3×; slice-173 |
