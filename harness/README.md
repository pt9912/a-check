...
| `make gates` | aggregiert die inneren Gates dieser Tabelle und schließt mit `record-gates`. Welche genau, sagt das [`Makefile`](../Makefile) — eine Liste hier wäre eine zweite Quelle | — (Aggregat) |
