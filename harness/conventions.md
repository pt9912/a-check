...
- **Stand:** [`v6.6.0`](https://github.com/pt9912/ai-harness-course/releases/tag/v6.6.0)
  (Release-Tag) — **Kurs-Welle 129 · 2026-09-08**, wie im Kopf des vendored
  [`regelwerk/README.md`](../.harness/baseline/v6.6.0/regelwerk/README.md) ausgewiesen.
- **Ort:** **committet vendored** unter
  [`.harness/baseline/v6.6.0/`](../.harness/baseline/v6.6.0/regelwerk/README.md), Integrität
...
- **Vendored Baseline (Regelwerk + Templates) — die Lese-Form:**
  ...
  (Index) und
  [`.harness/baseline/v6.6.0/templates/README.md`](../.harness/baseline/v6.6.0/templates/README.md).
...
|---|---|---|---|
| [MR-012](conventions/MR-012-referenzmatrix-grandfathering.md) <a id="mr-012"></a> | Referenz-Richtung maschinell, ADRs 0001–0020 grandfathered | [`.d-check.yml`](../.d-check.yml) (`matrix`), [`docs/plan/adr/`](../docs/plan/adr/) | [`grundlagen-referenz-richtung.md` §Referenz-Richtung (SDP)](../.harness/baseline/v6.6.0/regelwerk/grundlagen-referenz-richtung.md#referenz-richtung-sdp-wer-darf-wen-referenzieren) |
| [MR-014](conventions/MR-014-keine-agenten-telemetrie.md) <a id="mr-014"></a> | Keine Agenten-Telemetrie | gesamtes Repo; Baseline-Modul `modul-15` | [`modul-15-observability.md` §Kernidee](../.harness/baseline/v6.6.0/regelwerk/modul-15-observability.md#kernidee-modul-15) |
| [MR-015](conventions/MR-015-welle-closure-ohne-replay.md) <a id="mr-015"></a> | Welle-Closure ohne Replay-Lauf (`make ci` grün) | [`docs/plan/planning/`](../docs/plan/planning/README.md) | [`modul-06-roadmap.md` §Wellen-Closure-Prozedur](../.harness/baseline/v6.6.0/regelwerk/modul-06-roadmap.md#wellen-closure-prozedur-modul-6) |
| [MR-016](conventions/MR-016-validator-unbesetzt.md) <a id="mr-016"></a> | Validator-Rolle unbesetzt | gesamtes Repo; Baseline-Modul `modul-08` | [`modul-08-agentenrollen.md` §Die neun Übergaben](../.harness/baseline/v6.6.0/regelwerk/modul-08-agentenrollen.md#die-neun-übergaben-und-ihre-artefakte-modul-8) |
...
| **Gate-/Werkzeug-Schicht** — `tools/`, `Makefile`, `Dockerfile`, `.claude/`, `.github/workflows/` | `GATE` | 1,2,3 | Greenfield | jedes Target ist im Gate-Index ([`harness/README.md`](README.md) §Sensors) deklariert, bevor es zählt; `make doc-targets` erzwingt das. Pfadliste um `.github/workflows/` ergänzt mit [slice-138](../docs/plan/planning/done/wellenlos/slice-138-sub-area-kuerzel.md) — deckt, was zuvor lose als „CI-Schicht"/„CI-/Build-Schicht"/„Durchsetzungsschicht" firmierte | n/a (GF) |
...
| **Benutzer-Doku** — `docs/user/` | `USER` | 2,3 | Greenfield | Das Dokument folgt dem Stand der kanonischen Quellen, nie umgekehrt: Handbuch, Standard-Handbuch und Release-Anleitung ziehen Lastenheft, Regel-Tabelle und ADRs nach. Eigene Pfad-Familie, eigene Diskrepanz-Zeile; ohne sie hat ein Fund in dieser Familie **keinen** Register-Ort, weil die Kennung des Registers der Pfad `BEO-<KUERZEL>/<slug>` ist | n/a (GF) |
