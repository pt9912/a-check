...
| **Benutzer-Doku** — `docs/user/` | `USER` | 2,3 | Greenfield | Das Dokument folgt dem Stand der kanonischen Quellen, nie umgekehrt: Handbuch, Standard-Handbuch und Release-Anleitung ziehen Lastenheft, Regel-Tabelle und ADRs nach. Eigene Pfad-Familie, eigene Diskrepanz-Zeile — bis slice-195 ohne Zeile, weshalb ein Fund in dieser Familie **keinen** Register-Ort hatte | n/a (GF) |
